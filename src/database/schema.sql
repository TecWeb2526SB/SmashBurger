...
INSERT INTO prodotti (categoria_id, nome, slug, descrizione, allergeni, immagine, prezzo_centesimi) VALUES
    ((SELECT id FROM categorie WHERE slug = 'burger'), 'Cheeseburger', 'cheeseburger', 'Patty di carne, cheddar, cetriolini, ketchup.', 'glutine, lattosio', 'images/cheeseburger.webp', 1090),
    ((SELECT id FROM categorie WHERE slug = 'burger'), 'Bacon Burger', 'bacon-burger', 'Patty di carne, bacon, cheddar, salsa al bacon.', 'glutine, lattosio', 'images/bacon-burger.webp', 1250),
    ((SELECT id FROM categorie WHERE slug = 'burger'), 'In-n-out', 'in-n-out', 'Patty di carne, cipolla cruda, insalata, pomodoro, cheddar.', 'glutine, lattosio', 'images/in-n-out.webp', 1150),
    ((SELECT id FROM categorie WHERE slug = 'burger'), 'Chicken Burger', 'chicken-burger', 'Tender di pollo, maionese, insalata.', 'glutine, uova', 'images/chicken-burger.webp', 1050),
    ((SELECT id FROM categorie WHERE slug = 'burger'), 'Piccante', 'piccante', 'Patty di carne, nduja, spianata piccante, provola, cipolla caramellata.', 'glutine, lattosio', 'images/piccante.webp', 1350),
    ((SELECT id FROM categorie WHERE slug = 'burger'), 'Italiano', 'italiano', 'Patty di carne, caciocavallo, pomodori secchi, maionese al basilico e pinoli.', 'glutine, lattosio, frutta a guscio', 'images/italiano.webp', 1400),
    ((SELECT id FROM categorie WHERE slug = 'burger'), 'Chicken BBQ', 'chicken-bbq', 'Sovracoscia di pollo, salsa barbecue e miele, bacon, insalata coleslaw, edamer fuso.', 'glutine, lattosio', 'images/chicken-bbq.webp', 1300),
    ((SELECT id FROM categorie WHERE slug = 'burger'), 'Vegan Burger', 'vegan-burger', 'Pollo vegetale, coleslaw vegana, maionese piccante vegana, lattuga.', 'glutine, soia', 'images/vegan-burger.webp', 1250),
    ((SELECT id FROM categorie WHERE slug = 'contorni'), 'Patate fritte', 'patate-fritte', 'Patate fritte con sale.', 'possibili tracce di glutine', 'images/patate.webp', 390),
    ((SELECT id FROM categorie WHERE slug = 'contorni'), 'Chicken wings', 'chicken-wings', 'Alette di pollo speziate con salsa barbecue.', 'senape, soia', 'images/chicken-wings.webp', 550),
    ((SELECT id FROM categorie WHERE slug = 'contorni'), 'Tenders di pollo', 'tenders-di-pollo', 'Striscioline di pollo fritte.', 'glutine', 'images/tenders-di-pollo.webp', 600),
    ((SELECT id FROM categorie WHERE slug = 'contorni'), 'Panzerotti', 'panzerotti', 'Panzerotti fritti ripieni di pomodoro e mozzarella.', 'glutine, lattosio', 'images/panzerotti.webp', 450),
    ((SELECT id FROM categorie WHERE slug = 'bevande'), 'Bibita alla spina', 'bibita-alla-spina', 'Bicchiere da 40 cl, gusto a scelta al banco.', NULL, 'images/cup.webp', 250),
    ((SELECT id FROM categorie WHERE slug = 'bevande'), 'Acqua naturale', 'acqua-naturale', 'Bottiglia da 50 cl.', NULL, 'images/acqua-naturale.webp', 150),
    ((SELECT id FROM categorie WHERE slug = 'bevande'), 'Acqua frizzante', 'acqua-frizzante', 'Bottiglia da 50 cl.', NULL, 'images/acqua-frizzante.webp', 150),
    ((SELECT id FROM categorie WHERE slug = 'bevande'), 'Birra artigianale', 'birra-artigianale', 'Bottiglia da 33 cl.', 'glutine', 'images/birra-artigianale.webp', 500),
    ((SELECT id FROM categorie WHERE slug = 'dessert'), 'Cono gelato', 'cono-gelato', 'Cono gelato classico.', 'glutine, lattosio', 'images/cono-gelato.webp', 300),
    ((SELECT id FROM categorie WHERE slug = 'dessert'), 'Milkshake alla vaniglia', 'milkshake-vaniglia', 'Milkshake al gusto di vaniglia.', 'lattosio', 'images/milkshake-vaniglia.webp', 450),
    ((SELECT id FROM categorie WHERE slug = 'dessert'), 'Milkshake alla banana', 'milkshake-banana', 'Milkshake al gusto di banana.', 'lattosio', 'images/milkshake-banana.webp', 450),
    ((SELECT id FROM categorie WHERE slug = 'dessert'), 'Milkshake alla fragola', 'milkshake-fragola', 'Milkshake al gusto di fragola.', 'lattosio', 'images/milkshake-fragola.webp', 450);
