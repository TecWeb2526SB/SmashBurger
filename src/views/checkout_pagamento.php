<?php
/**
 * checkout_pagamento.php: Step 3 checkout - pagamento.
 *
 * Variabili attese:
 *   $carrello         array
...
<section aria-labelledby="titolo-checkout-pagamento">
    <div class="contenitore">
        ...
        <form class="checkout-card checkout-form checkout-main" method="POST" action="checkout_pagamento.php" data-valida novalidate>
            ...
            <div class="checkout-navigation">
                <a class="bottone-secondario" href="checkout_ritiro.php">&larr; Torna al ritiro</a>
