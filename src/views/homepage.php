    ...
    <div class="contenitore">
        <div class="home-hero-grid">
            <div class="hero-content">
                ...
                <div class="hero-cta">
                    <a href="prodotti.php" class="bottone-primario">Inizia l'ordine</a>
                    <a href="sedi.php" class="bottone-secondario">Trova sede</a>
                </div>
    ...
    <div class="contenitore">
        ...
        <div class="menu-preview-grid">
            <article class="menu-preview-card" aria-labelledby="best-1">
                ...
                <?php if (is_logged_in()): ?>
                    <form action="carrello.php" method="POST" class="scheda-prodotto-azioni">
        ...
        <p class="home-bottom-cta">
            <a href="prodotti.php" class="bottone-secondario">Vedi il catalogo completo</a>
        </p>
    </div>
</section>
