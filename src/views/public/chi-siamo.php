...
<!-- ==========================================================
     6. CTA FINALE — invito all'azione
     ========================================================== -->
<section class="chi-cta" aria-labelledby="chi-cta-titolo">
    <div class="contenitore">
        <div class="chi-cta-box">
            <h2 id="chi-cta-titolo">Vieni a trovarci</h2>
            <p>
                Siamo presenti in cinque citt&agrave; italiane. Trova la sede pi&ugrave;
                vicina a te e scopri il vero sapore dello smash burger.
            </p>
            <div class="chi-cta-azioni">
                <a href="sedi" class="bottone-primario">Trova la sede</a>
                <a href="prodotti" class="bottone-secondario">Scopri il menu</a>
            </div>
        </div>
    </div>
</section>
