...
<section id="best-seller" aria-labelledby="titolo-best-seller">
    <div class="contenitore">
        ...
        <div class="feature-grid">
            <article class="feature-card" aria-labelledby="best-1">
            ...
            <article class="feature-card" aria-labelledby="best-2">
            ...
            <article class="feature-card" aria-labelledby="best-3">
...
<section id="promozioni" aria-labelledby="titolo-promozioni">
    <div class="contenitore">
        ...
        <div class="feature-grid">
            <article class="feature-card" aria-labelledby="titolo-studente">
                <h3 id="titolo-studente">Menu Studente</h3>
                <p>Burger classico, patatine e bevanda con sconto 15% mostrando badge universitario.</p>
                <p class="hero-panel-note">Valido dal lunedì al venerdì, fascia pranzo.</p>
            </article>
            <article class="feature-card" aria-labelledby="titolo-famiglia">
                <h3 id="titolo-famiglia">Combo Famiglia</h3>
                <p>Quattro burger classici + due porzioni grandi di patatine a prezzo agevolato.</p>
                <p class="hero-panel-note">Ideale per 3-4 persone.</p>
            </article>
            <article class="feature-card" aria-labelledby="titolo-bundle">
                <h3 id="titolo-bundle">Bundle Serata</h3>
                <p>Due burger premium + onion rings + due birre artigianali a tariffa ridotta.</p>
                <p class="hero-panel-note">Disponibile tutti i giorni dopo le 18:30.</p>
            </article>
        </div>
    </div>
</section>
