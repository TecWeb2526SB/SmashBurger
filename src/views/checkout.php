<?php
/**
 * checkout.php: Step 1 checkout - conferma ordine.
 *
 * Variabili attese:
 *   $carrello  array
 *   $errori    array
...
<section aria-labelledby="titolo-checkout">
    <div class="contenitore">
        ...
        <form class="checkout-card checkout-form checkout-main" method="POST" action="checkout.php" aria-label="Conferma ordine">
            ...
            <div class="checkout-navigation">
                <a class="bottone-secondario" href="carrello.php">&larr; Torna al carrello</a>
