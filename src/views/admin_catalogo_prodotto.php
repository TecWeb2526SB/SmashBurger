<?php
/**
 * admin_catalogo_prodotto.php: View flusso guidato catalogo globale.
 *
 * Variabili attese:
    ...
    <div class="contenitore">
        <div class="account-page-head">
            ...
            <div class="account-action-row">
                <a class="bottone-secondario" href="admin_catalogo.php">&larr; Torna al catalogo</a>
                <a class="bottone-secondario" href="admin_catalogo_prodotto.php<?php echo $existingProduct !== null ? '?id=' . (int) $existingProduct['id'] . '&amp;reset=1' : '?reset=1'; ?>">Azzera bozza</a>
            </div>
        </div>
        ...
        <div class="checkout-shell admin-product-shell">
            <div class="checkout-card checkout-form checkout-main admin-product-main">
                <?php if ($currentStep === 'dettagli'): ?>
                    <form method="POST" action="admin_catalogo_prodotto.php<?php echo $existingProduct !== null ? '?id=' . (int) $existingProduct['id'] : ''; ?>" data-valida novalidate aria-labelledby="titolo-step-dettagli">
                        ...
                        <div class="checkout-navigation">
                            <a class="bottone-secondario" href="admin_catalogo.php">&larr; Annulla</a>
                ...
                <?php elseif ($currentStep === 'immagine'): ?>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="admin_catalogo_prodotto.php<?php echo $imageStepQuery !== '' ? '?' . $imageStepQuery : ''; ?>" aria-labelledby="titolo-step-immagine">
                        <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <form method="POST" action="admin_catalogo_prodotto.php<?php echo $imageStepQuery !== '' ? '?' . $imageStepQuery : ''; ?>" class="checkout-navigation checkout-navigation--solo-azione admin-product-back-form">
                        <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8'); ?>">
                ...
                <?php else: ?>
                    ...
                    <div class="checkout-navigation">
                        ...
                        <form method="POST" action="admin_catalogo_prodotto.php<?php echo $reviewStepQuery !== '' ? '?' . $reviewStepQuery : ''; ?>">
                            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8'); ?>">
