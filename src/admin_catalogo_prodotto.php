...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!csrf_is_valid($csrfTokenForm)) {
        ...
        header('Location: admin_catalogo_prodotto.php' . ($productId > 0 ? '?id=' . $productId : ''));
        exit;
    }
    ...
    try {
        if ($action === 'save_details') {
            ...
            header('Location: admin_catalogo_prodotto.php?' . http_build_query(array_filter([
...
$breadcrumb = [
    ['Home', 'index.php'],
    ['Controllo', 'admin.php'],
    ['Catalogo', 'admin_catalogo.php'],
    [$existingProduct !== null ? 'Modifica prodotto' : 'Nuovo prodotto', null],
];

include_once __DIR__ . '/views/template/header.php';
include_once __DIR__ . '/views/admin_catalogo_prodotto.php';
